# @wrtnlabs/connector-career

By installing the package, you can use functions for `Career`.
...
install the `@wrtnlabs/connector-career` package.

```bash
npm install @wrtnlabs/connector-career
```
    ...
    controllers: [
      {
        ...
        protocol: "class",
        application: typia.llm.application<CareerService, "chatgpt">(),
        execute: new CareerService(),
      },
    ],
  });
