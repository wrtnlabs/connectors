# @wrtnlabs/connector-google-docs

By installing the package, you can use functions for `Google docs`.
...
install the `@wrtnlabs/connector-google-docs` package.
