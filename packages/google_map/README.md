...
By installing the package, you can use functions for `Google map`.
...
install the `@wrtnlabs/connector-google-map` package.

```bash
npm install @wrtnlabs/connector-google-map
```
