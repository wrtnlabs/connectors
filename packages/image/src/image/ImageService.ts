...
import { IImageService } from "../structures/IImageService";
...
export class ImageService {
  ...
  async getCroppedImage(
    input: IImageService.GetImageFileInput,
  ): Promise<IImageService.GetImageFileOutput> {
    ...
    const targetSize = this.changeImageSize({ ...input, ...size });
   ...
   */
  changeImageSize(input: IImageService.GetSizeInput): IImageService.Size {
    let maxWidth: number;
